...
"use client"
import { AddEditProject } from "@/app/components/dashboard/projects/addAddEditProject";
...
export default function ProjectsPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
        {openModal && (
            <Modal element={<AddEditProject initialProjectData={null} />} onClose={() => setOpenModal(false)} />
           )}
